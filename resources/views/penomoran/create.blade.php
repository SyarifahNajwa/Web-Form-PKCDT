    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('penomoran.store') }}" method="POST" id="penomoranForm">
                    @csrf
                    ...
                    <div class="step-panel hidden" data-step="2">
                        ...
                        <div class="mb-4">
                            <x-input-label for="alamat_pengiriman" :value="__('Alamat Pengiriman Barang')" />
                        ...
                        <div class="mb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <x-input-label for="identitas_penerima" :value="__('Identitas Penerima Barang')" />
                            ...
                            <div>
                                <x-input-label for="nama_penerima" :value="__('Nama Penerima Barang')" />
                        ...
                        <div class="mb-4">
                            <x-input-label for="alamat_penerima" :value="__('Alamat Penerima Barang')" />
                        ...
                        <div class="mb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <x-input-label for="no_tgl_izin_pjt" :value="__('No & Tgl Surat Izin PJT/NP-PPJK')" />
                            ...
                            <div>
                                <x-input-label for="cara_pengangkut" :value="__('Cara Pengangkutan')" />
                        ...
                        <div class="mb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <x-input-label for="nama_sarana_angkut" :value="__('Nama Sarana Pengangkut')" />
                    ...
                    <div class="step-panel hidden" data-step="3">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="nomor_bc11" class="block mt-1 w-full" type="text" name="nomor_bc11" :value="old('nomor_bc11')" autocomplete="nomor_bc11" />
                            <x-input-error :messages="$errors->get('nomor_bc11')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="nomor_pos" :value="__('Nomor POS')" />
                            <x-text-input id="nomor_pos" class="block mt-1 w-full" type="text" name="nomor_pos" :value="old('nomor_pos')" autocomplete="nomor_pos" />
                            <x-input-error :messages="$errors->get('nomor_pos')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="invoice" :value="__('Invoice')" />
                            <x-text-input id="invoice" class="block mt-1 w-full" type="text" name="invoice" :value="old('invoice')" autocomplete="invoice" />
                            <x-input-error :messages="$errors->get('invoice')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="tanggal_invoice" :value="__('Tanggal Invoice')" />
                            <x-text-input id="tanggal_invoice" class="block mt-1 w-full" type="date" name="tanggal_invoice" :value="old('tanggal_invoice')" />
                            <x-input-error :messages="$errors->get('tanggal_invoice')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="nomor_bl_awb" :value="__('Nomor BL/AWB')" />
                            <x-text-input id="nomor_bl_awb" class="block mt-1 w-full" type="text" name="nomor_bl_awb" :value="old('nomor_bl_awb')" autocomplete="nomor_bl_awb" />
                            <x-input-error :messages="$errors->get('nomor_bl_awb')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="tanggal_bl_awb" :value="__('Tanggal BL/AWB')" />
                            <x-text-input id="tanggal_bl_awb" class="block mt-1 w-full" type="date" name="tanggal_bl_awb" :value="old('tanggal_bl_awb')" />
                            <x-input-error :messages="$errors->get('tanggal_bl_awb')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="negara_asal" :value="__('Negara Asal Barang')" />
                            <x-text-input id="negara_asal" class="block mt-1 w-full" type="text" name="negara_asal" :value="old('negara_asal')" autocomplete="negara_asal" />
                            <x-input-error :messages="$errors->get('negara_asal')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="valuta" :value="__('Valuta')" />
                            <x-text-input id="valuta" class="block mt-1 w-full" type="text" name="valuta" :value="old('valuta')" autocomplete="valuta" maxlength="5" />
                        ...
                        <div class="mb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-text-input id="fob" class="block mt-1 w-full" type="number" step="0.01" name="fob" :value="old('fob')" />
                                <x-input-error :messages="$errors->get('fob')" class="mt-2" />
                            </div>
                            <div>
                                <x-input-label for="freight" :value="__('Freight')" />
                                <x-text-input id="freight" class="block mt-1 w-full" type="number" step="0.01" name="freight" :value="old('freight')" />
                        ...
                        <div class="mb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-text-input id="asuransi" class="block mt-1 w-full" type="number" step="0.01" name="asuransi" :value="old('asuransi')" />
                                <x-input-error :messages="$errors->get('asuransi')" class="mt-2" />
                            </div>
                            <div>
                                <x-input-label for="nilai_cif" :value="__('Nilai CIF')" />
                                <x-text-input id="nilai_cif" class="block mt-1 w-full" type="number" step="0.01" name="nilai_cif" :value="old('nilai_cif')" />
                    ...
                    <div class="mt-4 flex items-center justify-between gap-2">
                        ...
                        <x-primary-button id="submitBtn" type="submit" class="hidden">Simpan Data</x-primary-button>
                    </div>
                </form>
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function () {
                        ...
                        const form = document.getElementById('penomoranForm');
