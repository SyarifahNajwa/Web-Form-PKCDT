                    ...
                    <form method="POST" action="{{ route('penomoran-form.savePage5', $penomoran->id) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="nomor_bc11" name="nomor_bc11" type="text" class="mt-1 block w-full" value="{{ old('nomor_bc11', $pib->nomor_bc11 ?? '') }}" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="tanggal_bc11" name="tanggal_bc11" type="date" class="mt-1 block w-full" value="{{ old('tanggal_bc11', $pib->tanggal_bc11?->format('Y-m-d') ?? '') }}" required />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="nomor_pos" name="nomor_pos" type="text" class="mt-1 block w-full" value="{{ old('nomor_pos', $pib->nomor_pos ?? '') }}" required />
                                @error('nomor_pos')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                            </div>
                            <div>
                                <x-input-label for="invoice" :value="__('Invoice')" />
                                <x-text-input id="invoice" name="invoice" type="text" class="mt-1 block w-full" value="{{ old('invoice', $pib->invoice ?? '') }}" required />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="tanggal_invoice" name="tanggal_invoice" type="date" class="mt-1 block w-full" value="{{ old('tanggal_invoice', $pib->tanggal_invoice?->format('Y-m-d') ?? '') }}" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="nomor_bl_awb" name="nomor_bl_awb" type="text" class="mt-1 block w-full" value="{{ old('nomor_bl_awb', $pib->nomor_bl_awb ?? '') }}" required />
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="tanggal_bl_awb" name="tanggal_bl_awb" type="date" class="mt-1 block w-full" value="{{ old('tanggal_bl_awb', $pib->tanggal_bl_awb?->format('Y-m-d') ?? '') }}" required />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="negara_asal_barang" name="negara_asal_barang" type="text" class="mt-1 block w-full" value="{{ old('negara_asal_barang', $pib->negara_asal_barang ?? '') }}" required />
                                @error('negara_asal_barang')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                            </div>
                            <div>
                                <x-input-label for="valuta" :value="__('Valuta')" />
                                <x-text-input id="valuta" name="valuta" type="text" class="mt-1 block w-full" placeholder="USD, EUR, IDR" value="{{ old('valuta', $pib->valuta ?? '') }}" maxlength="5" required />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="fob" name="fob" type="number" step="0.01" class="mt-1 block w-full" value="{{ old('fob', $pib->fob ?? '') }}" required />
                                @error('fob')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                            </div>
                            <div>
                                <x-input-label for="freight" :value="__('Freight')" />
                                <x-text-input id="freight" name="freight" type="number" step="0.01" class="mt-1 block w-full" value="{{ old('freight', $pib->freight ?? '') }}" required />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <div>
                                ...
                                <x-text-input id="asuransi" name="asuransi" type="number" step="0.01" class="mt-1 block w-full" value="{{ old('asuransi', $pib->asuransi ?? '') }}" required />
                                @error('asuransi')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                            </div>
                            <div>
                                <x-input-label for="nilai_cif" :value="__('Nilai CIF')" />
                                <x-text-input id="nilai_cif" name="nilai_cif" type="number" step="0.01" class="mt-1 block w-full" value="{{ old('nilai_cif', $pib->nilai_cif ?? '') }}" required />
